            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 bg-[#243447] rounded-lg flex items-center justify-center hover:bg-[#2d4058] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" fill="#1a2332"/>
                  <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="#1a2332" strokeWidth="2"/>
                </svg>
              </a>
              <a href="#" className="w-10 h-10 bg-[#243447] rounded-lg flex items-center justify-center hover:bg-[#2d4058] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33A2.78 2.78 0 003.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 001.94-2 29 29 0 00.46-5.25 29 29 0 00-.46-5.33z"/>
                  <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" fill="#1a2332"/>
                </svg>
              </a>
            </div>
          </div>
