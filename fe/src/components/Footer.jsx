...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1a2332] text-[#b8c5d6] px-20 py-4">
        ...
        <div className="flex justify-between gap-20 mb-10">
          ...
          <div className="flex-1 max-w-md">
            ...
            <p className="text-[#b8c5d6] leading-relaxed mb-8">
              Discover your next favorite read with our curated collection of books from around the
              world. Join millions of readers on their literary journey.
            </p>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-[#243447] rounded-lg flex items-center justify-center hover:bg-[#2d4058] transition-colors"
              >
                <TwitterIcon />
              </a>
              <a
          ...
          <div className="flex-shrink-0">
            ...
            <ul className="space-y-3">
              {quickLinks.map((item) => (
                <li
                  key={item.name}
                  className="transition-colors duration-200 cursor-pointer ease-in-out hover:text-white"
