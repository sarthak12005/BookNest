        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-12">
          ...
          <div className="flex flex-col gap-5 max-w-xl">
            ...
            <p className="text-gray-600 text-lg">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore quod vitae eligendi
              minus iste nostrum?
            </p>
          ...
          {/* RIGHT GRID */}
          <div className="w-full md:w-[700px] h-[450px] relative">
            <FloatingGrid />
          </div>
        </div>
      </div>
