    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          Welcome to the BookNest admin panel. Monitor system metrics and manage access control
          lists.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map(({ label, value, icon: Icon, color, bg, path }) => (
          ...
          >
            ...
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center border transition-all duration-300 group-hover:scale-110 ${bg} ${color}`}
            >
              <Icon size={22} />
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">
                    Manage levels and authorization
                  </span>
                </div>
              </div>
              <ArrowRight
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">
                    View and update API action codes
                  </span>
                </div>
              </div>
              <ArrowRight
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-[0_2px_8px_rgba(30,41,59,0.04)] overflow-hidden lg:col-span-2 flex flex-col justify-between">
          <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
            ...
            <span className="inline-flex text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-md uppercase tracking-wider border border-indigo-100">
              Live
            </span>
          </div>
          ...
          <div className="p-8 flex flex-col items-center justify-center text-center flex-1 my-10 space-y-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs mt-1.5 max-w-sm mx-auto">
                Real-time charts, user logs, and system diagnostics are processing. Configure your
            ...
            <div className="w-48 bg-slate-100 h-2.5 rounded-full overflow-hidden relative">
              <div
                className="absolute top-0 bottom-0 left-0 bg-indigo-500 rounded-full animate-[loadingProgress_2s_infinite_ease-in-out]"
                style={{ width: '60%' }}
              />
            </div>
          </div>
